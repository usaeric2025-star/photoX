        ...
        <section className="space-y-4">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span>{t.others} / OTHERS ({t.dimensions}, {t.description})</span>
            </div>
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between px-1">
                    <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest pl-1 leading-none">{t.multiLangDesc}</label>
                  </div>
                  
                  <div className="space-y-3">
                    <div className="space-y-1.5">
                      <span className="text-[9px] font-black text-slate-400 uppercase px-1">{t.zhDesc}</span>
                      <textarea 
                    ...
                    <div className="space-y-1.5">
                      <span className="text-[9px] font-black text-slate-400 uppercase px-1">{t.enDesc}</span>
                      <textarea 
                        placeholder={t.description} 
                        className="w-full bg-white border border-slate-200 p-4 rounded-2xl text-sm font-medium outline-none focus:border-blue-500 shadow-sm min-h-[80px]"
                    ...
                    <div className="space-y-1.5">
                      <span className="text-[9px] font-black text-slate-400 uppercase px-1">{t.msDesc}</span>
                      <textarea 
                        placeholder={t.description} 
                        className="w-full bg-white border border-slate-200 p-4 rounded-2xl text-sm font-medium outline-none focus:border-blue-500 shadow-sm min-h-[80px]"
