...
export const PHOTO_LIST_FIELDS = 'id, name, item_code, manual_code, model_number, price, description, image_url, thumb_hash, created_at, updated_at, group_id, is_group_cover, is_hidden, is_pinned, is_analyzing, user_id, category_id, manufacturer_id, dimensions, description_translations, photo_tags(tag_id)';

// Detail query fields - comprehensive set of physical columns used for editing and detailed views
export const PHOTO_DETAIL_FIELDS = 'id, name, item_code, manual_code, model_number, image_hash, category_id, manufacturer_id, sub_category, description, image_url, thumb_hash, created_at, updated_at, group_id, is_group_cover, is_hidden, is_pinned, is_analyzing, user_id, price, description_translations, dimensions, group_order, photo_tags(tag_id)';
