...
export function LightboxFloatingInfo({
  ...
  return (
    <div className={`fixed top-[72px] left-8 z-40 pointer-events-none flex flex-col items-start max-w-[85%] md:max-w-[40%] select-none animate-in fade-in slide-in-from-top-2 duration-700`}>
