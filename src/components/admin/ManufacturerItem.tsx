      ...
      <AnimatePresence>
        {activeMenuId === manufacturer.id && (
          ...
          >
            ...
            <AlertDialog>
              <AlertDialogTrigger className="px-3 py-2 text-red-400 text-[10px] font-black uppercase tracking-widest hover:bg-white/10 rounded-lg flex items-center gap-2">
                <Trash2 size={12} /> 删除
              </AlertDialogTrigger>
              <AlertDialogContent>
                <AlertDialogHeader>
