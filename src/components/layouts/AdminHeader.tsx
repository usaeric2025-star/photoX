...
import { Search, Grid3x3, Grid2x2, LayoutGrid, ArrowUpDown, Layers, Upload, Settings, User, Trash2, CheckSquare } from 'lucide-react';
...
export function AdminHeader({
  ...
  currentSort = 'newest',
  // New props for AdminToolbar compatibility
  photos,
        ...
        <div className="flex items-center gap-2">
          ...
          {onMultiSelect && (
            <button
              ...
              className={`p-1.5 rounded-lg ${isMultiSelect ? 'bg-blue-500 text-white' : 'hover:bg-slate-100'}`}
              title="多选"
            >
              <CheckSquare size={16} />
            </button>
