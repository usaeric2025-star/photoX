...
export function FormSectionHeader({ title, subtitle, onAction, actionLabel }: SectionHeaderProps) {
  return (
...
export function CategoryGrid({ categories, selectedId, onSelect, appLang }: CategorySelectorProps) {
  return (
...
export function ManufacturerList({ manufacturers, selectedId, onSelect, onEdit, onDelete }: ManufacturerSelectorProps) {
