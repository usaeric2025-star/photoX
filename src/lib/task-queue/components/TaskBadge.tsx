...
import { isTaskDrawerOpen, useSignal, useTranslation } from '#src/hooks/index.js';
import { globalTaskStatusSignal, globalTaskProgressSignal } from '#src/services/task/taskService.js';
