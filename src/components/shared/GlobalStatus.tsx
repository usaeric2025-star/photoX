...
export function GlobalStatus() {
  ...
  return (
    <div
      ...
      className="fixed bottom-6 left-6 z-[100] cursor-pointer group animate-fade-up"
    >
      <div className="bg-brand-navy text-white rounded-2xl p-3 pl-4 pr-5 shadow-2xl flex items-center gap-3 border border-white/10 overflow-hidden relative">
        {/* Progress Background */}
        <div 
          className="absolute inset-0 bg-blue-500/20 origin-left transition-transform duration-1000 ease-in-out"
