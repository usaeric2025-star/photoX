...
// Let's create a new streamlined version. We will preserve only the most critical rules (e.g., Storve, Valibot, Drizzle, Hono).
// But for now, let's just grab the headers to see what's in it.
const headers = lines.filter(l => l.startsWith('#'));
console.log('Headers:', headers.length);

// We can just keep a simplified version
const newContent = `# PhotoX 核心開發規範 (2026-06 精簡版)
...
fs.writeFileSync('AGENTS.md', newContent);
console.log('Simplified AGENTS.md');
