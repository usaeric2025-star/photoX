    ...
    <AnimatePresence>
      {showInfo && (
        <motion.div
          ...
          transition="fast"
          className="absolute top-24 sm:top-28 right-4 sm:right-6 w-[280px] sm:w-[320px] max-h-[calc(100vh-200px)] overflow-y-auto rounded-3xl bg-black/80 backdrop-blur-xl border border-white/10 shadow-2xl p-5 sm:p-6 z-[160] no-scrollbar pointer-events-auto"
        >
