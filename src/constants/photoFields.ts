...
export const PHOTO_LIST_FIELDS = 'id, name, image_url, thumb_url, thumb_hash, created_at, updated_at, group_id, is_group_cover, is_hidden, is_pinned, is_analyzing, user_id, category_id, photo_tags(tag_id)';
