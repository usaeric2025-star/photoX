...
/**
 * Agnes Service: Handles translation and dimension extraction
 */
export const agnesService = {
  /**
   * Translate text into Chinese, English and Malay
   */
  translate: async (text: string, signal?: AbortSignal): Promise<AgnesTranslations> => {
...
Output strictly in JSON format:
{
   ...
   */
  extractDimensions: async (text: string, signal?: AbortSignal): Promise<AgnesDimensions> => {
