  ...
  return (
    <div ref={containerRef} className="h-full w-full overscroll-y-contain relative">
      {isFetching && photos.length > 0 && (
        <div className="absolute inset-0 bg-white/20 backdrop-blur-[1px] z-20 flex items-center justify-center pointer-events-none transition-all duration-200">
          <div className="bg-white/90 shadow-md rounded-full p-2.5 border border-slate-200/50 flex items-center justify-center">
